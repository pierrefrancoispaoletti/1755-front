import { faBeer, faCocktail, faGlassChampagne, faGlassCitrus, faGlassWhiskeyRocks, faHatChef, faWineBottle } from "@fortawesome/pro-duotone-svg-icons";
        ...
        subCategories: [
            {
                name: "Vins Rouges",
                slug: "rouges",
                icon: <FontAwesomeIcon size="3x" icon={faWineBottle} style={{"--fa-primary-color": "darkred"}} />,
                subCat: [
                    {
                        name:"Vins Corses",
                        slug:"corses"
            ...
            },
            {
                name: "Vins Rosés",
                slug: "roses",
                icon: <FontAwesomeIcon size="3x" icon={faWineBottle} style={{"--fa-primary-color": "#fec5d9"}} />,
            },
            {
                name: "Vins Blancs",
                slug: "blancs",
                icon: <FontAwesomeIcon size="3x" icon={faWineBottle} style={{"--fa-primary-color": "#f1f285"}} />,
            },
            {
                name: "Champagnes",
                slug: "champagnes",
                icon: <FontAwesomeIcon size="3x" icon={faGlassChampagne} style={{"--fa-secondary-color": "#f1f285"}} />,
            }
